...
public enum FHIR {
    ...
    public typealias EncounterStatus = ModelsR4.EncounterStatus
    public typealias MedicationRequestStatus = ModelsR4.MedicationrequestStatus
    public typealias Dosage = ModelsR4.Dosage
}
